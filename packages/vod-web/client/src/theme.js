...
export default class ThemeProvider extends Component {
  constructor() {
    super();
    this.setHTMLStyle(initialTheme);
    loadTheme(initialTheme);
    this.state = { theme: initialTheme };
  }

  setHTMLStyle(theme) {
    document.getElementsByTagName('html')[0].style.backgroundColor = theme.palette.bodyBackground;
    document.getElementsByTagName('body')[0].style.fontFamily = theme.typography.families.default;
    document.getElementsByTagName('body')[0].style.color = theme.palette.bodyText;
  }
